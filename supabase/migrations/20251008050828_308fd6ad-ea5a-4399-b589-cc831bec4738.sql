...
INSERT INTO public.tier_configs (tier, level, name, referral_threshold, commission_rate, base_earnings, quality_bonus, social_posts_required, min_monthly_transactions) VALUES
...
CREATE INDEX idx_transactions_ambassador_id ON public.transactions(ambassador_id);
CREATE INDEX idx_transactions_status ON public.transactions(status);
CREATE INDEX idx_referrals_ambassador_id ON public.referrals(ambassador_id);
CREATE INDEX idx_social_posts_ambassador_id ON public.social_posts(ambassador_id);
CREATE INDEX idx_payouts_ambassador_id ON public.payouts(ambassador_id);
