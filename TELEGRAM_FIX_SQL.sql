...
-- Run this SQL in your Supabase SQL Editor to fix Telegram connection issues
...
-- Add comment
COMMENT ON FUNCTION update_ambassador_telegram_info IS 'Securely update ambassador Telegram connection info, bypassing RLS restrictions';