-- ============================================
-- FIX PARAMETER NAMES ERROR
-- ============================================
-- This fixes the parameter name conflict by dropping the specific function first

-- 1. Drop existing functions with specific signatures
...
-- 2. Create admin role check function using app_role enum
CREATE OR REPLACE FUNCTION public.has_role(check_user_id UUID, role_name public.app_role)
RETURNS BOOLEAN
LANGUAGE plpgsql
SECURITY DEFINER
...
-- 3. Create application update function
...
-- 4. Create profile creation function
...
-- 5. Create ambassador profile function
