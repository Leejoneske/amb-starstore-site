-- ============================================
-- FIX REJECTION_REASON AMBIGUITY - FINAL FIX
-- ============================================
-- This fixes the rejection_reason ambiguity by using variables
...
-- 2. Create application update function (FINAL FIX)
...
BEGIN
  ...
  IF rejection_reason_param IS NOT NULL THEN
    final_rejection_reason := rejection_reason_param;
  ELSE
