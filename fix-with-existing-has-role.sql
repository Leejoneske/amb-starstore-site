-- ============================================
-- FIX WITH EXISTING HAS_ROLE FUNCTION
-- ============================================
-- This works with the existing has_role function instead of replacing it

-- 1. Drop only the new functions (not has_role)
...
-- 2. Create application update function (using existing has_role)
