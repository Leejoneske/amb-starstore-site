...
-- This creates all the message tracking tables and features
...
CREATE POLICY "Allow service role to manage all messages" ON messages
  FOR ALL TO service_role USING (true);

-- RLS Policies for message_attachments
CREATE POLICY "Allow authenticated users to read attachments" ON message_attachments
  FOR SELECT TO authenticated USING (true);

CREATE POLICY "Allow service role to manage all attachments" ON message_attachments
  FOR ALL TO service_role USING (true);

-- RLS Policies for message_events
CREATE POLICY "Allow authenticated users to read events" ON message_events
  FOR SELECT TO authenticated USING (true);

CREATE POLICY "Allow service role to manage all events" ON message_events
  FOR ALL TO service_role USING (true);

-- RLS Policies for message_templates
CREATE POLICY "Allow authenticated users to read active templates" ON message_templates
  FOR SELECT TO authenticated USING (is_active = true);

CREATE POLICY "Allow service role to manage all templates" ON message_templates
  FOR ALL TO service_role USING (true);
